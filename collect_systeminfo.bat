...
echo =================
echo Gathering WLAN configuration
echo =================
netsh WLAN show drivers >> wlanipconfig.txt
netsh wlan show interfaces >> wlanipconfig.txt
echo Done!
echo.
...
REM echo =================
REM echo Dumping the registry
REM echo =================
REM reg export HKLM hklm.reg
REM reg export HKCU hkcu.reg
REM reg export HKCU hkcr.reg
REM reg export HKCU hku.reg
REM reg export HKCU hkcc.reg
REM echo Done!
REM echo.

REM echo =================
REM echo Collecting logs, this may take a bit...
REM echo =================
REM ..\psloglist -x system > system.log
REM ..\psloglist -x security > security.log
REM ..\psloglist -x application > application.log
REM echo Done!
REM echo.
